...
if st.button("Summon Sheep"):
    st.image("https://media.giphy.com/media/3ohhwehR8oQSD0W9Fu/giphy.gif", caption="A wild sheep appears!")
    st.markdown('Open the sidebar and press **"Play"** if you want to play the game.')
